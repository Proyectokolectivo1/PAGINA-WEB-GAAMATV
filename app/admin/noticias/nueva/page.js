...
export default function NuevaNoticia() {
  ...
  useEffect(() => {
    if (form.titulo && !form.slug) {
      setForm(prev => ({ ...prev, slug: generateSlug(form.titulo) }))
    }
  }, [form.titulo])
  ...
  return (
    <div className="max-w-4xl">
      <div className="mb-6">
        <h1 className="font-headline text-2xl font-bold text-on-surface">Nueva Noticia</h1>
        <p className="text-on-surface-variant">Crea una nueva noticia para el portal</p>
      </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-xs text-on-surface-variant mt-1">
                Puedes usar HTML básico para el formato
              </p>
            </div>
          </div>
        </div>
